# -*- coding: utf-8 -*-
"""
Created on Mon Sep  5 09:07:05 2022
...
def detect_object(frame):
    cfg_path = os.path.abspath('/content/drive/MyDrive/Colab Notebooks/Computer Vision/Yolo/yolov4.cfg')
    weights_path = os.path.abspath('/content/drive/MyDrive/Colab Notebooks/Computer Vision/Yolo/yolov4.weights')
    names_path = os.path.abspath('/content/drive/MyDrive/Colab Notebooks/Computer Vision/Yolo/coco.names.txt')
